                    ...
                    <div class="container" style="max-width: 1600px;">
                        <div class="col-lg-5">
                            ...
                            <div class="btns">
                                ...
                                <a href="//www.ringid.com/dl"  target="_blank"  class="header-btn join" id="myBtn">START MINING</a>
                            </div>
                        </div>
                        <div class="col-lg-7">
...
//                console.log('hitted');
                ...
                $.ajax({url: "<?php echo $server_url_ajax; ?>", success: function (result) {
                        ...
                        //}
                        //if (total_reward_new > old_reward_counter) {
