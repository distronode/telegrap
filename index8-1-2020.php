                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
							...
							<div class="clearfix"></div>
                            <a class="header-btn read" href="javascript:void(0);" style="margin-top: 12px;margin-bottom: 18px; float: none; display: inline-block;cursor:default;color:#1baae4!important;padding:14px 30px 13px 30px">Coming Soon</a>
