...
<html lang="en">
    <head>
        ...
        <meta name="description" content="A Unit of ringID Digital Share to create a borderless digital economy">
        ...
        <section id="home">
                    ...
                    <div class="container" style="max-width: 1600px;">
                        <div class="col-lg-5">
                            <div class="crytotext t-a-l">
                                <div class="headline">A mainstream cryptocurrency to create a borderless economy for daily life transactions.</div>
                                <div class="desc">A ringbit is a Unit that is equivalent to ringID Digital Share Value. Every New User joining the ringID Network generates ringbit. A Portion of generated ringbit is distributed among its user as a REWARD..<br /><br />The value of Each Unit of ringbit will grow as the Network Grow!</div>
                            </div>
                        </div>
                        <div class="col-lg-7">
            ...
            <div class="row counter-header">
                <div class="col-lg-4 one">
                    <div class="text-counter" style="height:90px;padding-top: 25px;"><span style="font-size:16px;color:#68e6ff;">Base Value 1 - 100M Users&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 1 RB = 1 USD<br/><span style="font-size:16px;color:#68e6ff;">Base Value 100M - 200M Users</span> 1 RB = 5 USD</div>
                </div>
                ...
                <div class="fmid">
                    <div class="container">
                        <div class="footer-nav target-to t-a-c">
                            <p>Copyright &copy; 2017-<?php echo date("Y"); ?>.All Rights Reserved by ringbit</p>
                        </div>
                    </div>
                </div>
            </div>
